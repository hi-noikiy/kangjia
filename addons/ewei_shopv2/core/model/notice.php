...
class Notice_EweiShopV2Model 
{
	...
	public function sendTeamMessage($orderid = '0', $delRefund = false) 
	{
		...
		$datas = array( array('name' => '商城名称', 'value' => $_W['shopset']['shop']['name']), array('name' => '粉丝昵称', 'value' => $member['nickname']), array('name' => '订单号', 'value' => $order['orderno']), array('name' => '订单金额', 'value' => ($order['price'] - $order['creditmoney']) + $order['freight']), array('name' => '运费', 'value' => $order['freight']), array('name' => '商品详情', 'value' => $goods), array('name' => '快递公司', 'value' => $order['expresscom']), array('name' => '快递单号', 'value' => $order['expresssn']), array('name' => '下单时间', 'value' => date('Y-m-d H:i', $order['createtime'])), array('name' => '支付时间', 'value' => date('Y-m-d H:i', $order['paytime'])), array('name' => '发货时间', 'value' => date('Y-m-d H:i', $order['sendtime'])), array('name' => '收货时间', 'value' => date('Y-m-d H:i', $order['finishtime'])) );
		...
		if ($delRefund == true) 
		{
			...
			$msg = array( 'first' => array('value' => '您的订单已经完成退款！', 'color' => '#000000'), 'keyword1' => array('title' => '退款金额', 'value' => '¥' . $price . '元', 'color' => '#000000'), 'keyword2' => array('title' => '商品详情', 'value' => $goods . $orderpricestr, 'color' => '#000000'), 'keyword3' => array('title' => '订单编号', 'value' => $order['orderno'], 'color' => '#000000'), 'remark' => array('value' => '退款金额 ¥' . $price . $refundtype . "\r\n" . ' 【' . $shop['name'] . '】期待您再次购物！', 'color' => '#000000') );
		...
		else if ($order['status'] == 1) 
		{
			if ($order['success'] == 1) 
			{
				...
				{
					$msg = array( 'first' => array('value' => '您参加的拼团已经成功组团！', 'color' => '#000000'), 'keyword1' => array('title' => '订单号', 'value' => $value['orderno'], 'color' => '#000000'), 'keyword2' => array('title' => '时间', 'value' => date('Y-m-d H:i', $value['paytime']), 'color' => '#000000'), 'keyword3' => array('title' => '商品', 'value' => $order_goods['title'], 'color' => '#000000'), 'remark' => array('value' => $remark, 'color' => '#000000') );
				...
				$msgteam = array( 'first' => array('value' => '拼团已经成功组团！', 'color' => '#000000'), 'keyword1' => array('title' => '商品信息', 'value' => $goods, 'color' => '#000000'), 'keyword2' => array('title' => '付款金额', 'value' => $orderpricestr, 'color' => '#000000'), 'keyword3' => array('title' => '预计发货时间', 'value' => date('Y-m-d H:i:s', time()), 'color' => '#000000'), 'remark' => array('value' => $remarkteam, 'color' => '#000000') );
			...
			else if ($order['success'] == -1) 
			{
				...
				$msg = array( 'first' => array('value' => '您参加的拼团组团失败！', 'color' => '#000000'), 'keyword1' => array('title' => '店铺', 'value' => $shop['name'], 'color' => '#000000'), 'keyword2' => array('title' => '通知时间', 'value' => date('Y-m-d H:i:s', time()), 'color' => '#000000'), 'keyword3' => array('title' => '商品', 'value' => $order_goods['title'], 'color' => '#000000'), 'remark' => array('value' => $remark, 'color' => '#000000') );
				foreach ($order as $key => $value ) 
				{
			...
			else if ($order['success'] == 0) 
			{
				...
				$msg = array( 'first' => array('value' => '您的订单已提交成功！', 'color' => '#000000'), 'keyword1' => array('title' => '店铺', 'value' => $shop['name'], 'color' => '#000000'), 'keyword2' => array('title' => '下单时间', 'value' => date('Y-m-d H:i:s', $order['createtime']), 'color' => '#000000'), 'keyword3' => array('title' => '商品', 'value' => $goods, 'color' => '#000000'), 'keyword4' => array('title' => '金额', 'value' => $orderpricestr, 'color' => '#000000'), 'remark' => array('value' => $remark, 'color' => '#000000') );
				$this->sendGroupsNotice(array('openid' => $openid, 'tag' => 'groups_pay', 'default' => $msg, 'url' => $url, 'datas' => $datas));
				if (!($order['is_team'])) 
				{
					$tm = m('common')->getSysset('notice');
					$remarkteam = '单购订单成功了，准备发货';
					$msgteam = array( 'first' => array('value' => '单购订单成功了！', 'color' => '#000000'), 'keyword1' => array('title' => '商品信息', 'value' => $goods, 'color' => '#000000'), 'keyword2' => array('title' => '付款金额', 'value' => $orderpricestr, 'color' => '#000000'), 'keyword3' => array('title' => '预计发货时间', 'value' => date('Y-m-d H:i:s', time()), 'color' => '#000000'), 'remark' => array('value' => $remarkteam, 'color' => '#000000') );
					$business = explode(',', $tm['openid']);
					foreach ($business as $value ) 
					{
						$this->sendGroupsNotice(array('openid' => $value, 'tag' => 'groups_teamsend', 'default' => $msgteam, 'datas' => $datas));
		...
		else if ($order['status'] == 2) 
		{
			...
			$msg = array( 'first' => array('value' => '您的订单已发货！', 'color' => '#000000'), 'keyword1' => array('title' => '店铺', 'value' => $shop['name'], 'color' => '#000000'), 'keyword2' => array('title' => '发货时间', 'value' => date('Y-m-d H:i:s', $order['sendtime']), 'color' => '#000000'), 'keyword3' => array('title' => '商品', 'value' => $order_goods['title'], 'color' => '#000000'), 'keyword4' => array('title' => '快递公司', 'value' => $order['expresscom'], 'color' => '#000000'), 'keyword5' => array('title' => '快递单号', 'value' => $order['expresssn'], 'color' => '#000000'), 'remark' => array('value' => $remark, 'color' => '#000000') );
			...
			if (($order['status'] == 2) || (($order['status'] == 1) && !(empty($order['sendtype'])))) 
			{
				if (empty($order['dispatchtype'])) 
				{
					...
					if (empty($order['sendtype'])) 
					{
						...
						$remark = '<a href=\'' . $url . '\'>点击快速查询物流信息</a>';
						$text = '您的宝贝已经成功发货！ ' . "\n" . '商品名称：[商品详情]' . "\n" . '快递公司：[快递公司]' . "\n" . '快递单号：[快递单号]' . "\n" . $remark;
						$msg = array( 'first' => array('value' => '您的宝贝已经发货！', 'color' => '#000000'), 'keyword1' => array('title' => '订单编号', 'value' => $order['ordersn'], 'color' => '#000000'), 'keyword2' => array('title' => '快递公司', 'value' => $order['expresscom'], 'color' => '#000000'), 'keyword3' => array('title' => '快递单号', 'value' => $order['expresssn'], 'color' => '#000000'), 'remark' => array('value' => "\n" . '我们正加速送到您的手上，请您耐心等候。', 'color' => '#000000') );
	...
	public function sendMemberUpgradeMessage($openid = '', $oldlevel = NULL, $level = NULL) 
	{
		...
		$message = array( 'first' => array('value' => '亲爱的' . $member['nickname'] . '，恭喜您成功升级！' . "\n", 'color' => '#ff0000'), 'keyword1' => array('title' => '任务名称', 'value' => '会员升级', 'color' => '#000000'), 'keyword2' => array('title' => '通知类型', 'value' => '您会员等级从 ' . $oldlevelname . ' 升级为 ' . $level['levelname'] . ', 特此通知!', 'color' => '#000000'), 'remark' => array('value' => "\n" . '您即可享有' . $level['levelname'] . '的专属优惠及服务！', 'color' => '#000000') );
	...
	public function sendMemberLogMessage($log_id = '', $channel = 0, $isback = false) 
	{
		...
		$datas = array( array('name' => '商城名称', 'value' => $_W['shopset']['shop']['name']), array('name' => '粉丝昵称', 'value' => $member['nickname']) );
		...
		if ($log_info['type'] == 0) 
		{
			if ($log_info['status'] == 1) 
			{
				if ($isback) 
				{
					...
					$message = array( 'first' => array('value' => '亲爱的' . $member['nickname'] . '，您的' . $moneytext . '发生变动，具体如下：' . "\n", 'color' => '#000000'), 'keyword1' => array('title' => '充值金额', 'value' => $log_info['money'] . $yuan, 'color' => '#ff0000'), 'keyword2' => array('title' => '充值时间', 'value' => date('Y-m-d H:i', $log_info['createtime']), 'color' => '#000000'), 'keyword3' => array('title' => '账户余额', 'value' => $member['credit2'] . $yuan, 'color' => '#ff0000'), 'remark' => array('value' => '充值方式：管理员后台处理' . "\n\n" . $_W['shopset']['shop']['name'] . '感谢您的支持，如有疑问请联系在线客服。', 'color' => '#000000') );
				...
				else 
				{
					...
					$message = array( 'first' => array('value' => '恭喜您充值成功!', 'color' => '#000000'), 'keyword1' => array('title' => '充值金额', 'value' => $log_info['money'] . $yuan, 'color' => '#000000'), 'keyword2' => array('title' => '充值时间', 'value' => date('Y-m-d H:i', $log_info['createtime']), 'color' => '#000000'), 'keyword3' => array('title' => '账户余额', 'value' => $member['credit2'], 'color' => '#000000'), 'remark' => array('value' => "\n" . '谢谢您对我们的支持！', 'color' => '#000000') );
		...
		else if ($log_info['type'] == 1) 
		{
			if ($log_info['status'] == 1) 
			{
				...
				$message = array( 'first' => array('value' => '恭喜您已经成功提现，请检查您的账户余额。' . "\n", 'color' => '#ff0000'), 'keyword1' => array('title' => '申请提现金额', 'value' => $log_info['money'], 'color' => '#000000'), 'keyword2' => array('title' => '取提现手续费', 'value' => $log_info['deductionmoney'], 'color' => '#000000'), 'keyword3' => array('title' => '实际到账金额', 'value' => 123, 'color' => '#000000'), 'keyword4' => array('title' => '提现渠道', 'value' => $apply_type[$log_info['applytype']], 'color' => '#0a4b9c'), 'remark' => array('value' => "\n" . '如果您选择银行卡提现，预计在1-2个工作日内到账，如有疑问请联系在线客服或点击查看详情。', 'color' => '#000000') );
	...
	public function sendOrderChangeMessage($openid, $params, $type) 
	{
		...
		if ($type == 'orderstatus') 
		{
			$datas = array( array('name' => '粉丝昵称', 'value' => $member['nickname']), array('name' => '修改时间', 'value' => time()), array('name' => '订单号', 'value' => $params['orderid']), array('name' => '订单编号', 'value' => $params['ordersn']), array('name' => '原收货地址', 'value' => $params['olddata']), array('name' => '新收货地址', 'value' => $params['data']), array('name' => '订单原价格', 'value' => $params['olddata']), array('name' => '订单新价格', 'value' => $params['data']), array('name' => '订单更新内容', 'value' => $params['title']) );
			if (empty($params['url'])) 
			{
			...
			$msg = array( 'first' => array('value' => '亲爱的' . $member['nickname'] . '，您的' . $params['title'] . '已更新，详情如下：', 'color' => '#ff0000'), 'OrderSn' => array('title' => '订单编号', 'value' => $params['ordersn'], 'color' => '#000000'), 'remark' => array('value' => '原收货地址 : ' . $params['olddata'] . "\n" . '新收货地址 : ' . $params['data'] . "\n\n" . '如有疑问请联系在线客服。', 'color' => '#000000') );
			if ($params['type'] == '1') 
			{
